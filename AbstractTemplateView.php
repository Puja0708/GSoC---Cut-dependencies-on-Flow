...
\TYPO3\Flow\Mvc\ControllerContext ControllerContext;
 ...
 class AbstractTemplateView {
  ...
  /**
	...
	*public function injectTemplateParser(\TYPO3\Fluid\Core\Parser\TemplateParser $templateParser) {
	 ...
	 *
	 * @param $controllerContext Controller context which is available inside the view
	 * @return void
	 * @api
	 */
	 ...
	 */
	public function canRender($controllerContext) {
		return TRUE;
	}
}
